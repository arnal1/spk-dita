<div class="container-fluid">
  ...
  <h4 class="text-center mb-5">
    ...
    di Sistem Pendukung Keputusan pemilihan bantuan keluarga harapan berbasis web menggunakan metode <span class="text-success">Simple Additive Weighting</span>
  </h4>
